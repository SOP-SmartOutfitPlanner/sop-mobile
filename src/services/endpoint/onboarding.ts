...
import { GetStylesResponse } from "../../types/style";
...
export const GetStyles = async (): Promise<GetStylesResponse> => {
    const response = await apiClient.get<GetStylesResponse>("/styles");
    return response.data;
}
